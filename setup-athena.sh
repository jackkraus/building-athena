...
mkdir athena-32k-basket;
mkdir athena-64k-basket;
...
git clone https://github.com/arthurkraus3/building-athena.git;
rm athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/PoolWriteConfig.py;
mv building-athena/512k-basket/PoolWriteConfig.py athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/;
mv building-athena/package_filters.txt .;
mkdir build && cd build ; 
lsetup "asetup Athena,24.0.16" ; 
cmake -DATLAS_PACKAGE_FILTER_FILE=../package_filters.txt ../athena/Projects/WorkDir/ >& cmakelog;
...
# Clone and setup for athena-32k-basket
cd athena-32k-basket;
git clone https://gitlab.cern.ch/akraus/athena.git;
cd athena;
git remote add upstream https://:@gitlab.cern.ch:8443/atlas/athena.git ;
git fetch --all;
...
git clone https://github.com/arthurkraus3/building-athena.git;
rm athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/PoolWriteConfig.py;
mv building-athena/32k-basket/PoolWriteConfig.py athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/;
mv building-athena/package_filters.txt .;
mkdir build && cd build ; 
lsetup "asetup Athena,24.0.16" ; 
cmake -DATLAS_PACKAGE_FILTER_FILE=../package_filters.txt ../athena/Projects/WorkDir/ >& cmakelog;
...
# Clone and setup for athena-64k-basket
cd athena-64k-basket;
git clone https://gitlab.cern.ch/akraus/athena.git;
cd athena;
git remote add upstream https://:@gitlab.cern.ch:8443/atlas/athena.git ;
git fetch --all;
...
git clone https://github.com/arthurkraus3/building-athena.git;
rm athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/PoolWriteConfig.py;
mv building-athena/64k-basket/PoolWriteConfig.py athena/Database/AthenaPOOL/AthenaPoolCnvSvc/python/;
mv building-athena/package_filters.txt .;
mkdir build && cd build ; 
lsetup "asetup Athena,24.0.16" ; 
cmake -DATLAS_PACKAGE_FILTER_FILE=../package_filters.txt ../athena/Projects/WorkDir/ >& cmakelog;
